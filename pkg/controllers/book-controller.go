...
import (
	...
	"github.com/Ivan-Volgin/go-bookstore/pkg/models"
	"github.com/Ivan-Volgin/go-bookstore/pkg/utils"
...
func GetBookById(w http.ResponseWriter, r *http.Request){
	...
	bookDetatails, _ := models.GetBookById(ID)
	res, _ := json.Marshal(bookDetatails)
	w.Header().Set("Content-Type", "pkglication/json")
	w.WriteHeader(http.StatusOK)
	w.Write(res)
}
